...
This repository is a fork of the `artisynth_models` repository. This branch contains code used to run the simulations in Study 3 from Liu et al. (resubmitted).
