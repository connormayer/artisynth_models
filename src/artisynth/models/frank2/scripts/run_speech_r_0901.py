# run_speech_r_0901.py
# Batch (headless) simulation of the /r/ vowel for FrankModel2
...
FrankActivations.probe_snd_r_stavness_0901Cyd(rm, rm.mechModel, allExciters)  # 先加母音 probe
