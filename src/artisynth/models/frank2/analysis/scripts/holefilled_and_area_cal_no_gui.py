...
stl_path = r"C:\Users\yuron\git\artisynth_models\src\artisynth\models\frank2\output\temp_2026.07.14_09.32.19\geometry\frank_airway_tube_clipped_manual_0.395.stl"

# clear the default cube in the scene
...
output_path = stl_path.replace(".stl", "_filled.stl")
try:
    bpy.ops.wm.stl_export(filepath=output_path, export_selected_objects=True)
except AttributeError:
    bpy.ops.export_mesh.stl(filepath=output_path, use_selection=True)

print(f"Exported filled mesh to: {output_path}")