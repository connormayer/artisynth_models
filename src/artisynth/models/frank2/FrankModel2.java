...
public class FrankModel2 extends RootModel  
{
    public static PropertyList myProps =
       new PropertyList (FrankModel2.class, RootModel.class);

    static {
       myProps.add (
          "activationOrder",
          "batch activation order among active muscles",
          "SIMULTANEOUS");
    }
    ...
    /** Batch-only: relative activation order; probes are built from this. */
    protected String myActivationOrder = "SIMULTANEOUS";

    public String getActivationOrder() {
       return myActivationOrder;
    }

    public void setActivationOrder (String order) {
       myActivationOrder = order;
    }
...
//            GenericModel.renderFemMarkers    (fem, 0.7*scaling, new Color(0.6f, 0.0f, 0.6f));
        ...
        for (SkinMeshBody aw : new SkinMeshBody[]{airway, airway_tube, airway_tube_clipped})
        {
...
//            nStep++;
    ...
    public boolean getMenuItems(List<Object> items) 
    {
        ...
        items.add (GuiUtils.createMenuItem (this, "speech_a_wu2014", "")); // 新增這行
    ...
    public void actionPerformed (ActionEvent event) 
    {
        ...
        if      (cmd.equals ("speech_a"))
            ...
            FrankActivations.probe_snd_a_payan2009_new(this, mechModel, tongue);
        else if (cmd.equals ("speech_a_wu2014"))
            FrankActivations.probe_snd_a_wu2014_new(this, mechModel, tongue.getMuscleBundles(), tongue);
